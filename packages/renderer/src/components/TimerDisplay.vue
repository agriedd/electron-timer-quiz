  ...
  <div class="relative">
    ...
    >
      <div class="bg-gray-800 rounded-md p-3 border border-gray-900 max-w-md w-full shadow-lg">
        ...
        <div>
          <button
            class="px-4 py-3 bg-gradient-to-br from-gray-700 to-gray-800 rounded-xl text-gray-400 border border-gray-900
					text-sm
					hover:shadow-md active:shadow-sm active:border-blue-300 active:to-gray-800"
            @click="confirmDone()"
          >
            Konfirmasi
          </button>
    ...
    <div class="p-3">
      <div class="flex justify-center">
        <fieldset
          ...
          :style="{ opacity: timeRangeFormatted.hours.value == 0 && !edit_mode_enabled ? .3 : 1 }"
        >
        ...
        <div :style="{ opacity: timeRangeFormatted.hours.value == 0 && !edit_mode_enabled ? .3 : 1 }">
          <div class="h-full flex items-center">
            <div class="text-7xl font-bold py-5">
              :
            </div>
          </div>
        </div>
        <fieldset
          ...
          :style="{ opacity: timeRangeFormatted.minutes.value == 0 && !edit_mode_enabled ? .3 : 1 }"
        >
        ...
        <div :style="{ opacity: timeRangeFormatted.minutes.value == 0 && !edit_mode_enabled ? .3 : 1 }">
          <div class="h-full flex items-center">
            <div class="text-7xl font-bold py-5">
              :
            </div>
      ...
      <div class="flex justify-center">
        ...
        <div>
          <div class="flex h-full items-center pr-3">
            <button
              ...
              :class="[edit_mode_enabled ? 'from-gray-100 to-gray-50 fill-gray-400 border' : 'fill-white from-gray-900 to-gray-700 shadow-2xl shadow-gray-700']"
        ...
        <div>
          <div class="flex h-full items-center pl-3">
            <button
              class="p-3 rounded-full h-14 w-14 mr-1 bg-gradient-to-tl flex justify-end items-center"
              :class="[false ? 'from-gray-100 to-gray-50 fill-gray-400 border' : 'from-white to-white shadow-2xl shadow-gray-700 fill-gray-600']"
              @click="stopCounter"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
